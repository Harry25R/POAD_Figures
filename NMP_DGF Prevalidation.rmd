...
sig.genes <- TOP::filter_features(Data, Condition, contrast = "EAD - Control", nFeatures = 20)
...
fCPOP_model <- TOP_model(x_list, y_list, dataset_weights = Tissue, sample_weights = TRUE)
